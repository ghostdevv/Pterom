...
export default class Client {
    ...
    public async serverDetails(serverId: string): Promise<any> {
        return this.axiosHandler
            .request('GET', `api/client/servers/${serverId}`)
            .then((res) => res.data.attributes)
            .catch(this.errorType);
    }
    /*
    ...
    */
    ...
    public async listDatabases(serverId: string): Promise<any> {
        return this.axiosHandler
            .request('GET', `api/client/servers/${serverId}/databases`)
            .then((res) => res.data)
            .catch(this.errorType);
    }
     ...
     */
    public async listUsers(serverId: string): Promise<any> {
        return this.axiosHandler
     ...
     */
    public async userDetails(serverId: string, userId: string): Promise<any> {
        return this.axiosHandler
     ...
     */
    public async createBackup(serverId: string): Promise<any> {
        return this.axiosHandler
     ...
     */
    public async listVariables(serverId: string): Promise<any> {
        return this.axiosHandler
