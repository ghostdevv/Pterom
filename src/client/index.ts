...
export default class Client {
     ...
     * Lists all servers
     */
    public async listServers(): Promise<object> {
     ...
     */
    public async serverDetails(serverId: string): Promise<object> {
        return this.axiosHandler
    ...
    */
     ...
     */
    public async listDatabases(serverId: string): Promise<object> {
        return this.axiosHandler
